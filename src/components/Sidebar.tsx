        ...
        <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
          ...
          <div style={{
            ...
            <svg width="100%" height="100%" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M400 256C400 335.529 335.529 400 256 400C176.471 400 112 335.529 112 256C112 176.471 176.471 112 256 112C335.529 112 400 176.471 400 256Z" fill="url(#paint0_angular_logo_sidebar)" fillOpacity="0.8"/>
              <circle cx="256" cy="256" r="64" fill="url(#paint1_radial_logo_sidebar)"/>
              ...
              <defs>
                <radialGradient id="paint0_angular_logo_sidebar" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(256 256) rotate(90) scale(144)">
                  <stop offset="0" stop-color="#3B82F6"/>
                  <stop offset="0.33" stop-color="#8B5CF6"/>
                  <stop offset="0.66" stop-color="#EC4899"/>
                  <stop offset="1" stop-color="#F59E0B"/>
                </radialGradient>
                <radialGradient id="paint1_radial_logo_sidebar" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(256 256) rotate(90) scale(64)">
