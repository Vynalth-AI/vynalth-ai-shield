...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  actionBtnPrimary: { flex: 1, padding: '0.8rem', background: '#00d4aa', border: 'none', color: '#0a2540', fontWeight: '700', fontSize: '0.92rem', borderRadius: '8px', cursor: 'pointer', transition: 'all 0.2s ease-out' },
  actionBtnSecondary: { flex: 1, padding: '0.8rem', background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', color: 'var(--text-main)', fontWeight: '600', fontSize: '0.92rem', borderRadius: '8px', cursor: 'pointer', transition: 'all 0.2s ease-out' },
