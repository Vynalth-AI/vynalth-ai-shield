...
const styles: { [key: string]: React.CSSProperties } = {
  container: { display: 'flex', flexDirection: 'column', gap: '2rem', color: 'var(--text-main)' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  title: { fontSize: '2rem', fontWeight: '800', color: 'var(--primary)', letterSpacing: '-0.03em' },
  ...
  formPanel: { padding: '1.75rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', background: 'var(--bg-glass)', border: '1px solid var(--border-color)', borderRadius: '12px' },
  formPanelHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-color)', paddingBottom: '1rem' },
  panelTitle: { fontSize: '1.15rem', fontWeight: '700', color: 'var(--primary)', letterSpacing: '-0.02em' },
  formSelector: { background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', borderRadius: '8px', padding: '0.45rem 0.75rem', fontSize: '0.82rem', color: 'var(--text-main)', cursor: 'pointer', outline: 'none' },
  form: { display: 'flex', flexDirection: 'column' },
  widgetContainerOuter: { marginTop: '0.5rem', marginBottom: '1.5rem' },
  actionRow: { display: 'flex', gap: '0.75rem' },
  actionBtnPrimary: { flex: 1, padding: '0.8rem', background: '#00c7b1', border: 'none', color: '#ffffff', fontWeight: '700', fontSize: '0.92rem', borderRadius: '20px', cursor: 'pointer', transition: 'all 0.2s ease-out' },
  actionBtnSecondary: { flex: 1, padding: '0.8rem', background: 'var(--bg-primary)', border: '1px solid var(--border-color)', color: 'var(--text-main)', fontWeight: '700', fontSize: '0.92rem', borderRadius: '20px', cursor: 'pointer', transition: 'all 0.2s ease-out' },
  consolePanel: { padding: '1.5rem', height: '480px', display: 'flex', flexDirection: 'column', background: 'var(--bg-glass)', border: '1px solid var(--border-color)', borderRadius: '12px' },
  consoleHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.75rem', marginBottom: '1rem' },
  consoleIndicatorRow: { display: 'flex', alignItems: 'center', gap: '0.5rem' },
  consoleDot: { width: '8px', height: '8px', borderRadius: '50%', background: 'var(--secondary)', display: 'inline-block' },
  consoleTitle: { fontSize: '0.85rem', fontWeight: '700', color: 'var(--primary)', fontFamily: 'var(--font-mono)' },
  clearBtn: { background: 'transparent', border: 'none', color: 'var(--text-muted)', fontSize: '0.75rem', cursor: 'pointer', fontWeight: '500' },
  consoleBody: { flex: 1, background: 'var(--bg-secondary)', border: '1px solid var(--border-color)', borderRadius: '8px', padding: '1rem', overflowY: 'auto', fontFamily: 'var(--font-mono)', fontVariantNumeric: 'tabular-nums', fontSize: '0.78rem', color: 'var(--text-muted)', lineHeight: '1.5' },
  consoleEmpty: { color: 'var(--text-muted)', textAlign: 'center', padding: '3rem 1.5rem' },
  consoleOutput: { display: 'flex', flexDirection: 'column', gap: '0.4rem' },
  consoleLine: { color: 'var(--text-main)', whiteSpace: 'pre-wrap' },
  jsonOutput: { color: 'var(--secondary)', marginTop: '0.75rem', borderTop: '1px dashed var(--border-color)', paddingTop: '0.75rem', whiteSpace: 'pre-wrap' },
};
