...
const SAMPLE_AUDIT: AuditEntry[] = [
  { id: 'ae-001', timestamp: '2026-07-18 08:12:04 UTC', actor: 'admin@Vynalth.ai', action: 'KEY_ROTATION', resource: 'vault/aes-256-primary', outcome: 'success', hash: '0x3f9a1c…' },
  ...
  { id: 'ae-004', timestamp: '2026-07-17 23:18:02 UTC', actor: 'admin@Vynalth.ai', action: 'POLICY_UPDATE', resource: 'compliance/pdpa-v2', outcome: 'success', hash: '0x9d0f3e…' },
...
export const PrivacyCompliance: React.FC = () => {
  ...
  const [companyName, setCompanyName] = useState('Vynalth AI Shield Sdn Bhd');
  const [dpoEmail, setDpoEmail] = useState('dpo@Vynalth.ai');
...
## 1. Data Controller
${companyName} ("We", "Our") operates as the data controller for personal data processed via the Vynalth AI Shield behavioral verification platform.
...
*This policy was auto-generated by Vynalth AI Shield Privacy Compliance Module on ${new Date().toISOString()}.*
  `.trim();
